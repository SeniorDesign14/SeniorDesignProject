...
Use the 'location' column from the 'diningHalls' table to filter by dining hall (not 'hallname').
...
Use ILIKE for any string-based filtering, such as:
- diningHalls.location
- menu.food
...
export async function respondWithNaturalLanguage(question, results) {
  const prompt = `
...
`;
  ...
  try {
    ...
    console.error("GPT natural response error:", error);
